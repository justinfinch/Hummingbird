...
//FROM THE LINQKIT SOURCE: http://www.albahari.com/nutshell/linqkit.aspx
...
namespace Hummingbird.Data
{
	...
	class ExpressionExpander : ExpressionVisitor
	{
		...
		{
			if (m.Method.Name == "Invoke" && m.Method.DeclaringType == typeof (ExpressionHelper))
			{
			...
			if (m.Method.Name == "AsExpandable" && m.Method.DeclaringType == typeof (ExpressionHelper))
